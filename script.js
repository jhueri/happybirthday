document.addEventListener('DOMContentLoaded', function() {
    ...
    { id: 1, name: "Calm Smiski", color: "#c1f0c1", description: "This little one is doing yoga.", imageUrl: "./assets/LotusPose.png" },
    { id: 2, name: "Cheering Smiski", color: "#d1f5e0", description: "This Smiski is cheering you on!", imageUrl: "./assets/Cheer.png" },
    { id: 3, name: "Cat Smiski", color: "#e0f5d1", description: "Aww, this Smiski has a pet.", imageUrl: "./assets/Pet.png" },
    { id: 4, name: "Sleepy Smiski", color: "#c1e6c1", description: "This guy is eepy zzzZz.", imageUrl: "./assets/Sleep.png" },
    { id: 5, name: "Dress Up Smiski", color: "#b8e0b8", description: "Oops! This Smiski's getting dressed.", imageUrl: "./assets/Dressed.png" },
    { id: 6, name: "Drums Smiski", color: "#d8f3d8", description: "This Smiski's playing the drums for you. Dum dum dum.", imageUrl: "./assets/Drums.png" },
    { id: 7, name: "Studious Smiski", color: "#c9f2dc", description: "This Smiski's smart like you.", imageUrl: "./assets/Studious.png" },
    { id: 8, name: "Strong Smiski", color: "#d6f6dd", description: "This Smiski is getting big and strong.", imageUrl: "./assets/Strong.png" }
    ];
    ...
    <img src="${smiski.imageUrl}" class="smiski-head-image" alt="${smiski.name}">
    </div>
    </div>
